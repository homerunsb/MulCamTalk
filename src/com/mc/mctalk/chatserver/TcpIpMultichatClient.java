...
public class TcpIpMultichatClient {
	...
	public static void main(String args[]){
		...
		roomNum = JOptionPane.showInputDialog("입장하려는 방?");
		...
		try{
			...
			receiver.start();
			Thread sender = new ClientSender(socket, nick, roomNum);
			sender.start();
	...
	static class ClientSender extends Thread{
		final String TAG = "ClientSender : ";
		Socket socket;
		
		String name;
		String roomNum;
		
		ClientSender(Socket socket, String name, String roomNum){
			this.socket = socket;
			try{
...
//				}
	...
	static class ClientReceiver extends Thread{
		final String TAG = "ClientReceiver : ";
	...
	static class FrClient extends JFrame implements ActionListener{
		...
		public FrClient(String nick){
			...
			JLabel label = new JLabel("This is a Client!");
